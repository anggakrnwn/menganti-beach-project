      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Anchor size={24} />
              <span className="font-bold text-xl">Menganti Beach</span>
            </div>
            <p className="text-gray-300 mb-4">
              Keindahan tersembunyi di pesisir selatan Jawa Tengah, dengan pasir putih, tebing karang, dan air laut biru kehijauan yang menakjubkan.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#activities" className="text-gray-300 hover:text-white transition-colors">Aktivitas</a></li>
              <li><a href="#location" className="text-gray-300 hover:text-white transition-colors">Lokasi</a></li>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © {new Date().getFullYear()} Pantai Menganti. Hak Cipta Dilindungi.
          </p>
